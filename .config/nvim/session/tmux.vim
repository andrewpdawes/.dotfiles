" ~/.config/nvim/session/tmux.vim:
" Vim session script.
" Created by session.vim 2.13.1 on 10 February 2022 at 22:14:20.
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 123 + 127) / 255)
exe 'vert 2resize ' . ((&columns * 131 + 127) / 255)
argglobal
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
...
setlocal fen
silent! normal! zE
let s:l = 117 - ((39 * winheight(0) + 21) / 43)
