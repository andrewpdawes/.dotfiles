...
" URL: https://github/com/andrewpdawes
...
let g:colors_name="heedypo-light"


let Italic = ""
if exists('g:heedypo-light_italic')
  let Italic = "italic"
endif
let g:tender_italic = get(g:, 'heedypo-light_italic', 0)

let Bold = ""
if exists('g:heedypo-light_bold')
  let Bold = "bold"
endif

let g:tender_bold = get(g:, 'heedypo-light_bold', 0)
...
hi CursorLineNr guifg=#666666 ctermfg=245 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi Folded guifg=NONE ctermfg=241 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi FoldColumn guifg=NONE ctermfg=241 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi Normal guifg=#444444 ctermfg=237 guibg=#dadada ctermbg=253 gui=NONE cterm=NONE
...
hi SpellLocal guifg=#d7af00 ctermfg=178 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi StatusLine guifg=#1d1d1d ctermfg=241 guibg=#666666 ctermbg=NONE gui=Bold cterm=Bold
hi StatusLineNC guifg=#444444 ctermfg=238 guibg=#444444 ctermbg=NONE gui=NONE cterm=NONE
...
hi Visual guifg=NONE ctermfg=NONE guibg=#444444 ctermbg=237 gui=Bold cterm=Bold
hi VisualNOS guifg=NONE ctermfg=NONE guibg=#444444 ctermbg=237 gui=Bold cterm=Bold
...
hi Constant guifg=#d7af5f ctermfg=179 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi String guifg=#ffffd7 ctermfg=230 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi Number guifg=#afafd7  ctermfg=146 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi Float guifg=#ffc24b ctermfg=215 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi Identifier guifg=#afaf87 ctermfg=144 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi Function guifg=#af5f5f ctermfg=131 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi Statement guifg=#afd7af ctermfg=151 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi Conditional guifg=#afaf00 ctermfg=142 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi Operator guifg=#afd7d7 ctermfg=152 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi Type guifg=#afaf87 ctermfg=144 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi Special guifg=#afaf87 ctermfg=144 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi CocWarningSign guifg=#c9d05c ctermfg=180 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
