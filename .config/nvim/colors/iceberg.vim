...
if &background == 'light'
  hi Normal ctermbg=253 ctermfg=237 guibg=#e8e9ec guifg=#33374c
  ...
  hi StatusLineTerm cterm=NONE ctermbg=NONE ctermfg=243
  hi StatusLineNC cterm=NONE ctermbg=NONE ctermfg=251
  hi StatusLineTermNC cterm=NONE ctermbg=NONE ctermfg=251
  ...
  hi VertSplit cterm=NONE ctermbg=NONE ctermfg=251
  hi Visual ctermbg=NONE ctermfg=251 guibg=#c9cdd7 guifg=NONE
